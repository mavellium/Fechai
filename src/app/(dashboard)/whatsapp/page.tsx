...
export default async function WhatsappPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-8">
      <PageHeader
        eyebrow="whatsapp"
        title={connected ? "Seu WhatsApp" : "Conectar seu WhatsApp"}
        description={
          connected
            ? "Seu agente já responde neste número. Aqui você acompanha a conexão e os outros canais."
            : "Aponte a câmera do celular para o código e seu agente começa a atender no seu número."
        }
      />
