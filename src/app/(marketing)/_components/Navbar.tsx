...
import { CircleHelp, Layers, LogIn, Menu, UserPlus, Workflow, X, Zap } from "lucide-react";
            ...
            {LINKS.map((l) => (
              <a
                ...
                className={cn(
                  ...
                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-iris focus-visible:ring-offset-2 focus-visible:ring-offset-ink",
                  active === l.id ? "bg-white/10 text-white" : "text-white/60 hover:bg-white/5 hover:text-white",
                )}
              >
